...
sealed class Schema(protected open val features: Collection<Feature>) : Collection<Feature> by features, Serializable {
    data class Ordered(override val features: List<Feature> = emptyList()) : Schema(features), List<Feature> by features {
    ...
    data class Unordered(override val features: Set<Feature> = emptySet()) : Schema(features), Set<Feature> by features {
        override fun iterator(): Iterator<Feature> = features.iterator()
